...
public class FhirMessageConsumer extends AbstractSimpleKafka {
     ...
     */
    static Logger log = LoggerFactory.getLogger(FhirMessageConsumer.class.getName());
     ...
     */
    public FhirMessageConsumer() throws Exception {
    }
    ...
    void run(String topicName, KafkaMessageHandler callback, Integer numberOfRecords) throws Exception {
        Properties props = MessageHelper.getProperties();
